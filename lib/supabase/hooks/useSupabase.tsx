...
export const useSupabase = () => {
    ...
    return { products, getDataFromSupabase, getFilteredData, filterData, getMensClothing, getWomensClothing, getSingleProduct, mensProduct, womensProduct, singleProduct }
}
